...
public partial class DemodemodbContext : DbContext
{
    public DemodemodbContext()
    {
    }

    public DemodemodbContext(DbContextOptions<DemodemodbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;user=root;password=1234;database=demodemodb", ServerVersion.Parse("8.0.39-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdCaregory, "fk_products_categories_idx");
            ...
            entity.Property(e => e.IdCaregory).HasColumnName("id_caregory");
            entity.Property(e => e.IdDeliver).HasColumnName("id_deliver");
            entity.Property(e => e.IdManufacturer).HasColumnName("id_manufacturer");
            ...
            entity.HasOne(d => d.IdCaregoryNavigation).WithMany(p => p.Products)
                .HasForeignKey(d => d.IdCaregory)
